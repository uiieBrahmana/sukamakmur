                ...
                <div class="col-md-9">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            ...
                            <p class="text-muted text-center"><?php echo $Pegawai['status']; ?></p>

                            <ul class="list-group list-group-unbordered">
                                <li class="list-group-item">
                                    <b>ID PETUGAS</b> <a class="pull-right"> <?php echo $Pegawai['idpetugas']; ?></a>
                                </li>
                                <li class="list-group-item">
                                    <b>Tanggal Lahir</b> <a class="pull-right"> <?php echo $Pegawai['tglLahir']; ?></a>
                                </li>
                                <li class="list-group-item">
                                    <b>Jenis Kelamin</b> <a class="pull-right"><?php echo $Pegawai['jenisKelamin']; ?></a>
                                </li>
                            </ul>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <p class="text-muted"> <?php echo $Pegawai['email']; ?></p>

                            <hr>

                            <strong><i class="fa fa-user margin-r-5"></i> Username</strong>

                            <p class="text-muted"> <?php echo $Pegawai['username']; ?></p>
                            <hr>

                            <strong><i class="fa fa-lock margin-r-5"></i> Password</strong>

                            <p class="text-muted"> <?php echo $Pegawai['password']; ?></p>
                        </div>
                        <!-- /.box-body -->
                    </div>
                    <!-- /.box -->
